{{-- <x-guest-layout>
    <x-jet-authentication-card>
        ...
        <div class="mb-4 text-sm text-gray-600">
            {{ __('Lupa Kata Sandi Anda? Tidak ada masalah. Beri tahu kami alamat email Anda dan kami akan mengirimi Anda tautan reset kata sandi yang akan memungkinkan Anda memilih yang baru') }}
        </div>
...
<head>
    ...
    <title>AN3 - Lupa Kata Sandi</title>
    <!--fivicon icon-->
...
<body class='sc5-2'>
    ...
    <div class="container">
        <div class="align-items-center d-flex justify-content-center">
            <div class="register-page pt-4 text-center">
                <a class="btn back-page-btn" href="/"><i class="ri-arrow-left-s-line"></i></a>
                <h3>Cari Akun Anda</h3>
                <p>Masukkan nama pengguna atau email atau nomor telepon yang ditautkan ke akun anda</p>
                @if (session('status'))
            <div class="mb-4 font-medium text-sm text-green-600">
                {{ session('status') }}
            </div>
        ...
        <x-jet-validation-errors class="mb-4" />
                ...
                <a class="btn btn-base w-100" href="{{ route('register') }}">Lanjutkan</a>
